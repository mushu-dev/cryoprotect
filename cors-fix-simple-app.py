"""
CORS Fix for Simple App

This patch adds proper CORS configuration to the simple_app.py backend service.
Copy these changes into your simple_app.py file to enable correct CORS support.
"""
