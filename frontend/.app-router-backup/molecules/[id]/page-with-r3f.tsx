...
// This is an enhanced version of the molecule detail page that includes
// both the original 3DMol viewer and the new React Three Fiber viewer

export default function MoleculeDetailPageWithR3F() {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2">
          <Card>
            ...
            <CardContent>
              {/* Visualization Tabs */}
              <Tabs defaultValue="3dmol" className="-mx-6">
                <TabsList className="w-full justify-start px-6">
                  <TabsTrigger value="3dmol">
                    <Layers className="h-4 w-4 mr-2" />
                    3DMol.js Viewer
                  </TabsTrigger>
                  <TabsTrigger value="r3f">
