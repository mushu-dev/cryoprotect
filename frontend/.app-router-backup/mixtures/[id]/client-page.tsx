...
export default function ClientMixturePage({ id }: { id: string }) {
    ...
    <div className="space-y-6 container mx-auto px-4 py-6">
      ...
      <Tabs defaultValue="components">
        <TabsList className="w-full sm:w-auto flex sm:inline-flex overflow-x-auto">
          <TabsTrigger value="components" className="flex-1 sm:flex-initial">
            Components
          </TabsTrigger>
          <TabsTrigger value="visualization" className="flex-1 sm:flex-initial">
            Visualization
          </TabsTrigger>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {mixture.components.map((component, index) => (
                        <TableRow 
                          key={component.id} 
                          className={selectedMoleculeIndex === index ? "bg-muted" : "hover:bg-primary/5 cursor-pointer transition-colors"}
