...
class SandboxAgent:
    ...
    def append_screenshot(self):
        try:
            ...
            logger.log(f"Error with vision model: {str(e)}", "red")
            return "Error processing screenshot. I'll try to proceed by running a web browser command."
    ...
    def run(self, instruction):
        ...
        while should_continue:
            ...
            try:
                ...
                logger.log(f"Error with action model: {str(e)}", "red")
                # Fall back to a simple command
                content = "I'll open a web browser to search for the requested information."
                tool_calls = [
                    {
                        "type": "function",
                        "name": "run_command",
