...
# Blue/Green Deployment Script - Blue Environment
# This script deploys a new version to the blue environment
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    --help)
      ...
      echo "  --auto-switch        Automatically switch traffic to blue after successful deployment"
...
# Switch traffic to blue if auto-switch is enabled
