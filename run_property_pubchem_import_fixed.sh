#!/bin/bash
# Run property-based PubChem import with correct database parameters (fixed version)
...
podman cp /home/mushu/Projects/CryoProtect/property_based_pubchem_import_fixed.py $CONTAINER_NAME:/app/property_based_pubchem_import_fixed.py
