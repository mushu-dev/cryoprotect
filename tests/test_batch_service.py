"""
Tests for the BatchOperationService class in batch_resources.py.

These tests focus on the business logic of the batch operations service,
which is separated from the Flask-specific code for better testability.
"""
...
from api.batch_resources import BatchOperationService
