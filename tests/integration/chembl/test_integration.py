...
class TestChEMBLIntegration(unittest.TestCase):
    ...
    def test_error_handling_and_recovery(self):
        ...
        # Update checkpoint manually since we're mocking the queue
        self.checkpoint_manager.update_progress("CHEMBL25", success=True)
        ...
        # Update checkpoint manually since we're mocking the queue
        self.checkpoint_manager.update_progress("CHEMBL1118", success=False, error="Max retries exceeded")
        ...
        self.assertIn("CHEMBL1118", self.checkpoint_manager.state["failed_compounds"])
