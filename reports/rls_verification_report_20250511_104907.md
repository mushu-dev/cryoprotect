...
Generated on: 2025-05-11 10:49:07
...
Traceback (most recent call last):
  ...
  File "/home/mushu/Projects/CryoProtect/tests/rls_test_helper.py", line 215, in create_test_data
    raise e
  File "/home/mushu/Projects/CryoProtect/tests/rls_test_helper.py", line 41, in create_test_data
    cursor.execute(f"SELECT id FROM users WHERE id = '{user1_id}'")
    ~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
