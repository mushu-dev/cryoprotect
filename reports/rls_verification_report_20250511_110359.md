...
Generated on: 2025-05-11 11:03:59
...
```
Traceback (most recent call last):
  File "/home/mushu/Projects/CryoProtect/tests/test_rls_policies_verification.py", line 709, in test_experiment_property_non_user_project_access
    self.assertEqual(result.get('count', -1), 0)
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: -1 != 0
```
...
```
Traceback (most recent call last):
  File "/home/mushu/Projects/CryoProtect/tests/test_rls_policies_verification.py", line 700, in test_experiment_property_user_project_access
    self.assertGreater(result.get('count', 0), 0)
    ~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: 0 not greater than 0
```
...
```
Traceback (most recent call last):
  File "/home/mushu/Projects/CryoProtect/tests/test_rls_policies_verification.py", line 683, in test_mixture_component_user_project_access
    self.assertGreater(result.get('count', 0), 0)
    ~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: 0 not greater than 0
```
...
```
Traceback (most recent call last):
  File "/home/mushu/Projects/CryoProtect/tests/test_rls_policies_verification.py", line 675, in test_molecular_property_non_user_project_access
    self.assertEqual(result.get('count', -1), 0)
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: -1 != 0
```
...
```
Traceback (most recent call last):
  File "/home/mushu/Projects/CryoProtect/tests/test_rls_policies_verification.py", line 666, in test_molecular_property_user_project_access
    self.assertGreater(result.get('count', 0), 0)
    ~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: 0 not greater than 0
```

### test_service_role_delete_access (tests.test_rls_policies_verification.RLSServiceRoleAccessTests.test_service_role_delete_access)

```
Traceback (most recent call last):
  File "/home/mushu/Projects/CryoProtect/tests/test_rls_policies_verification.py", line 806, in test_service_role_delete_access
    self.assertNotIn('error', result)
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^
AssertionError: 'error' unexpectedly found in {'error': 'column "project_id" of relation "molecules" does not exist\nLINE 2:             INSERT INTO molecules (id, project_id, name, smi...\n                                               ^\n'}
```

### test_service_role_insert_access (tests.test_rls_policies_verification.RLSServiceRoleAccessTests.test_service_role_insert_access)

```
Traceback (most recent call last):
  File "/home/mushu/Projects/CryoProtect/tests/test_rls_policies_verification.py", line 765, in test_service_role_insert_access
    self.assertNotIn('error', result)
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^
AssertionError: 'error' unexpectedly found in {'error': 'column "project_id" of relation "molecules" does not exist\nLINE 2:             INSERT INTO molecules (id, project_id, name, smi...\n                                               ^\n'}
```
