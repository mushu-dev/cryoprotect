...
// Generated at: 2025-05-17T04:05:17.658Z
// Operation ID: 61b138c6d1b4eabf
...
// Result file
const resultPath = path.join(__dirname, 'result-61b138c6d1b4eabf.json');

// Log function
function log(message) {
  const logPath = path.join(__dirname, 'operation-61b138c6d1b4eabf.log');
...
async function performOperation() {
  ...
  try {
    ...
    // Take screenshot
    const screenshotPath = path.join(__dirname, 'screenshot-61b138c6d1b4eabf.png');
    ...
    result.data = { 
      ...
      relativePath: `screenshot-61b138c6d1b4eabf.png`
    };
