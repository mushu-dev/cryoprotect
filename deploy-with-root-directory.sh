#!/bin/bash
# Deploy directly to Vercel with correct root directory setting
...
echo "====================================================="
echo "CryoProtect Vercel Deployment with Root Directory Fix"
echo "====================================================="
...
# Update vercel.json with the rootDirectory setting
