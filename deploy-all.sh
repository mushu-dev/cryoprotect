...
# Step 1: Deploy the RDKit service to fly.io
...
if [ $? -eq 0 ]; then
    ...
    echo "The CryoProtect application has been fully deployed with Convex integration."
else
    echo
    echo "❌ Some integration tests failed."
    echo "You may need to manually check and fix the deployment."
fi
